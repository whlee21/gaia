...
public abstract class AbstractGATEMapper extends Mapper<Writable, Writable, Writable, Writable> {

	private static final Logger LOG = LoggerFactory.getLogger(AbstractGATEMapper.class);
	...
	protected void setup(Context context) throws IOException, InterruptedException {
		...
		String gapp_file = config.get("gate.application.descriptor", "application.xgapp");
