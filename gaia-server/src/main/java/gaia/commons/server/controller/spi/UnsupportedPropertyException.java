...
public class UnsupportedPropertyException extends Exception {
	...
	public UnsupportedPropertyException(Resource.Type type, Set<String> propertyIds) {
		super("The properties " + propertyIds
				+ " specified in the request or predicate are not supported for the resource type " + type + ".");
		this.type = type;
		this.propertyIds = propertyIds;
		this.error = new Error(type.toString(), Error.E_INVALID_TYPE, "The properties " + propertyIds
