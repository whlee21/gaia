 ...
 */
public abstract class ComparisonPredicate<T> extends PropertyPredicate
	...
	protected int compareValueTo(Object propertyValue)
			throws ClassCastException {

		if (doubleValue != null) {
			if (propertyValue instanceof Number) {
				return (int) (doubleValue - ((Number) propertyValue)
						.doubleValue());
	...
	private Double stringToDouble(String stringValue) {
		...
		return parsePosition.getIndex() == stringValue.length() ? parsedNumber
				.doubleValue() : null;
	}
