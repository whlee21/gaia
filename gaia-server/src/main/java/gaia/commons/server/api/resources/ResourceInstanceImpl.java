...
import gaia.commons.server.api.query.QueryImpl;
...
public class ResourceInstanceImpl implements ResourceInstance {
	private static final Logger LOG = LoggerFactory.getLogger(ResourceInstanceImpl.class);
  ...
  private ServerController m_controller = ServerControllerHelper.getServerController();
