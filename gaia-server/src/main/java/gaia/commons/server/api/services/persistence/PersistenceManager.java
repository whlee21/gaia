...
/**
 * Persistence manager which is responsible for persisting a resource state to
 * the back end. This includes create, update and delete operations.
 */
public interface PersistenceManager {
	 ...
	 * 
	 * @param resource
	 *            associated resource representation
	 * @param requestBody
	 ...
	 */
	public RequestStatus create(ResourceInstance resource,
			RequestBody requestBody) throws UnsupportedPropertyException,
	 ...
	 */
	public RequestStatus update(ResourceInstance resource,
			RequestBody requestBody) throws UnsupportedPropertyException,
			SystemException, NoSuchParentResourceException,
	 ...
	 * @throws NoSuchResourceException
	 */
	public RequestStatus delete(ResourceInstance resource,
			RequestBody requestBody) throws UnsupportedPropertyException,
			SystemException, NoSuchParentResourceException,
			NoSuchResourceException;
}
