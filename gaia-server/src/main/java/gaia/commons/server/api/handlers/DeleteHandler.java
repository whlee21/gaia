 ...
 */
public class DeleteHandler extends BaseManagementHandler implements
		RequestHandler {
	...
	protected Result persist(ResourceInstance resource, RequestBody body) {
		...
		try {
			...
			RequestStatus status = getPersistenceManager().delete(resource,
					body);
