...
public interface TreeNode<T> {
	 ...
	 * 
	 * @param child
	 *            the object associated with the new child node
	 * @param name
	...
	/**
	 * Find a child node by name. The name may contain '/' to delimit names to
	 * find a child more then one level deep. To find a node named 'bar' that is
	 * a child of a child named 'foo', use the name 'foo/bar'.
	 * 
	 * @param name
	 *            the name of the child. May contain the '/' path separator.
	 * 
