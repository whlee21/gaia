...
public class ReadHandler implements RequestHandler {
	...
	public Result handleRequest(Request request) {
		...
		try {
			...
			return new ResultImpl(new ResultStatus(
					ResultStatus.STATUS.BAD_REQUEST, e.getMessage()));
		}
		...
		try {
			...
			result = new ResultImpl(new ResultStatus(
					ResultStatus.STATUS.NOT_FOUND, e.getMessage()));
			...
			result = new ResultImpl(new ResultStatus(
					ResultStatus.STATUS.BAD_REQUEST, "Invalid Request: "
							+ e.getMessage()));
