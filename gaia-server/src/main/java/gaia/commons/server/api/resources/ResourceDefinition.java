...
import gaia.commons.server.api.services.ResultPostProcessor;
...
/**
 * Resource Definition. Provides information specific to a specific resource
 * type.
 */
public interface ResourceDefinition {
	...
	/**
	 * Obtain any resource post processors. A resource processor is used to
	 * provide resource specific processing of results and is called by the
	 * {@link ResultPostProcessor} while post processing a result.
	 * 
	...
	/**
	 * Resource specific result processor. Used to provide resource specific
