...
/**
 * Definition of a sub-resource. Defines a resource instance that is added to
 * another resource as a sub-resource.
 */
public class SubResourceDefinition {
	...
	/**
	 * Additional foreign key properties to include by default in the
	 * sub-resource.
	 */
	...
	/**
	 * Constructor. Simple constructor which uses default state for everything
	 * except resource type.
	 * 
	 * @param type
	 *            resource type
	 */
	...
	/**
	 * Constructor. This constructor allows all state to be set.
	 * 
	 * @param type
	 *            resource type
	 * @param setForeignKeys
	 *            set of additional foreign keys to include in resource by
	 *            default
	 * @param isCollection
	 *            whether the sub-resource is a collection
	 */
	public SubResourceDefinition(Resource.Type type,
			Set<Resource.Type> setForeignKeys, boolean isCollection) {
		m_type = type;
	...
	/**
	 * Get the set of additional foreign key properties that are included in the
	 * resource by default.
	 * 
	 * @return set of additional foreign key properties
	 */
	public Set<Resource.Type> getAdditionalForeignKeys() {
		return m_setForeignKeys == null ? Collections
				.<Resource.Type> emptySet() : m_setForeignKeys;
	}
