...
public class GaiaSearchGuiceServletConfig extends GuiceServletContextListener {
	
	private static final Logger LOG = LoggerFactory.getLogger(GaiaSearchGuiceServletConfig.class);
	private static Injector injector;
//	private static final GaiaSearchModule module = new GaiaSearchModule();


//	@Inject
	public GaiaSearchGuiceServletConfig(Injector injector) throws SchedulerException {
