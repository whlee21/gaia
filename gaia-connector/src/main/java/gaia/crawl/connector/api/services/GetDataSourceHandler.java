...
public class GetDataSourceHandler extends BaseHandler implements GetMethodHandler {

	public GetDataSourceHandler(ConnectorManager connManager, ObjectSerializer serializer, RequestBodyParser bodyParser) {
	...
	public Response handles(MultivaluedMap<String, String> queryParams, HttpHeaders headers) {
		...
		return buildResponse(Status.OK, ds.toMap());
	}
