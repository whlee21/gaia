...
public class GetHistoryHandler extends BaseHandler implements GetMethodHandler {

	public GetHistoryHandler(ConnectorManager connManager, ObjectSerializer serializer, RequestBodyParser bodyParser) {
	...
	public Response handles(MultivaluedMap<String, String> queryParams, HttpHeaders headers) {
		...
		try {
			return buildResponse(Status.OK, connManager.getHistory(key));
		} catch (Exception e) {
